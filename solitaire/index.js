...
// include: /var/folders/2x/b7sbnjnd1xz7w5lm_bw59qw00000gn/T/tmpzym5jyzt.js
...
var ASM_CONSTS = {
  241064: () => { if (document.fullscreenElement) return 1; },  
 241110: () => { return document.getElementById('canvas').width; },  
 241162: () => { return parseInt(document.getElementById('canvas').style.width); },  
 241230: () => { document.exitFullscreen(); },  
 241257: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 241330: () => { if (document.fullscreenElement) return 1; },  
 241376: () => { return document.getElementById('canvas').width; },  
 241428: () => { return screen.width; },  
 241453: () => { document.exitFullscreen(); },  
 241480: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 241613: () => { return window.innerWidth; },  
 241639: () => { return window.innerHeight; },  
 241666: () => { if (document.fullscreenElement) return 1; },  
 241712: () => { return document.getElementById('canvas').width; },  
 241764: () => { return parseInt(document.getElementById('canvas').style.width); },  
 241832: () => { if (document.fullscreenElement) return 1; },  
 241878: () => { return document.getElementById('canvas').width; },  
 241930: () => { return screen.width; },  
 241955: () => { return window.innerWidth; },  
 241981: () => { return window.innerHeight; },  
 242008: () => { if (document.fullscreenElement) return 1; },  
 242054: () => { return document.getElementById('canvas').width; },  
 242106: () => { return screen.width; },  
 242131: () => { document.exitFullscreen(); },  
 242158: () => { if (document.fullscreenElement) return 1; },  
 242204: () => { return document.getElementById('canvas').width; },  
 242256: () => { return parseInt(document.getElementById('canvas').style.width); },  
 242324: () => { document.exitFullscreen(); },  
 242351: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 242409: () => { return screen.width; },  
 242434: () => { return screen.height; },  
 242460: () => { return window.screenX; },  
 242487: () => { return window.screenY; },  
 242514: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 242567: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 242638: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 242695: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 242951: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 243022: () => { if (document.fullscreenElement) return 1; },  
 243068: () => { return window.innerWidth; },  
 243094: () => { return window.innerHeight; },  
 243121: () => { if (document.pointerLockElement) return 1; },  
